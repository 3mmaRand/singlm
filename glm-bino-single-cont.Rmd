...
<!-- The number of plasma reported by a clinic significantly decreases by a factor of `r b0_resp` $\pm$ `r b1se` for each kilometre from the nuclear plant (p `r modelp`). See figure \@ref(fig:fig-plasma-report). For a clinic at the plant, `r b0` $\pm$ `r b0se` plasma are expected -->
