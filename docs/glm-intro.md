...
### Tests of the model
With an lm() you get an *F* variance ratio test of the model over all when you view a summary. It answers the question "does the model explain a significant amount of the variance in the response relative to the response mean?" 

With a glm() you have to ask for a chi-squared test of deviance. It answers the question "does the model significantly decrease the deviance relative to the response mean?"
<code>
