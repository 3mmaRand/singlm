...
p1 <- df %>% 
  ...
  geom_smooth(method = "glm", 
              ...
              se = FALSE,
              colour = "black")   +
  annotate("text", x = 3, y = 0.9, label = expression(beta[1]~is~positive)) +
...
p2 <- df %>% 
  ...
  geom_smooth(method = "glm", 
              ...
              se = FALSE,
              colour = "black")   +
  annotate("text", x = 3, y = 0.1, label = expression(beta[1]~is~negative)) +
  scale_x_continuous(expand = c(0, 0), limits = c(0, 11)) +
  scale_y_continuous(expand = c(0, 0.01), name = "Probability of success") +
  theme_classic() +
  theme(axis.title.x = element_blank(),
